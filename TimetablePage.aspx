<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TimetablePage.aspx.cs" Inherits="TimetablePage" %>
...
<li class="selected"  ><a href="#">Design</a></li>
    ...
    <form id="form1" runat="server">
     ...
     <h3>Designing Time Table For  &nbsp; &nbsp; &nbsp;<asp:Label Font-Underline="true" runat="server" ID="yearLabel"></asp:Label>- <asp:Label runat="server"  Font-Underline="true" ID="sectionLabel"></asp:Label> </h3>
...
<div style=" margin-left:300px; float:left;"> <asp:Label ID="label" runat="server"   ForeColor="Black" Font-Size="Larger" Text="Dint Like it ?"/> <asp:Button  ID="regenarate" runat="server"   Height="30" Text="Regenerate" OnClick="regenarate_Click"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="label1" runat="server"   ForeColor="Black" Font-Size="Larger" Text="Liked it ?"/> <asp:Button  ID="save" runat="server"   Height="30" Text="SAVE"  OnClick="save_Click"/> </div>
