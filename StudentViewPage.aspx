<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentViewPage.aspx.cs" Inherits="StudentViewPage" %> 
 <!DOCTYPE html>
...
<li class="selected"  ><a href="#">View </a></li> 
    ...
    <div>
        <div>
    <div style="float:left; margin-left:200px;"><h3> Class &nbsp;:- <asp:Label ID="myYear"  runat="server" />-<asp:Label ID="mysection"  runat="server" />  </h3> </div>
